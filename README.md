...
[直接下载 APK](https://github.com/fushen1024/five-in-a-row/releases/download/v2.0.0/pine-gomoku-2.0.0-android.apk) · [Releases 发布说明](https://github.com/fushen1024/five-in-a-row/releases/tag/v2.0.0)

支持 Android 7.0 及以上。若已安装本仓库 Releases 的 1.0 APK，直接打开 2.0 APK 按系统提示更新，无需卸载，保留昵称和头像。2.0 沿用相同包名和签名证书，版本号提升至 `2.0.0+2`。自行编译或其他来源的不同签名版本不能保证覆盖。

蓝牙对战双方都需要升级到 2.0。当前为开发签名侧载包，尚未完成两台真机蓝牙验收。
...
| 静态分析 | 通过，无问题 |
| 自动测试 | 46 项通过 |
| Android Release APK 构建 | 通过，2.0.0 |
| APK 签名与应用信息检查 | 通过 |
...
应为设备限制所以目前无法完成iOS端的开发，欢迎有条件的朋友进行后续开发。
